...
public class EchoServer extends Thread{
    ...
    public void run() {		// metodo che aspetta l'arrivo di un messaggio e lo rimanda indietro
        running = true;		// alla variabile running viene assegnato true fino a quando non 
